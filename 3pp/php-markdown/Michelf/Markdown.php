...
abstract class _MarkdownExtra_TmpImpl extends \Michelf\Markdown {
	...
	# Tag2Question that are always treated as block tags:
	...
	# Tag2Question treated as block tags only if the opening tag is alone on its line:
	protected $context_block_tags_re = 'script|noscript|ins|del|iframe|object|source|track|param|math|svg|canvas|audio|video';
	
	# Tag2Question where markdown="1" default to span mode:
	protected $contain_span_tags_re = 'p|h[1-6]|li|dd|dt|td|th|legend|address';
	
	# Tag2Question which must not have their contents modified, no matter where
	# they appear:
	protected $clean_tags_re = 'script|math|svg';
	
	# Tag2Question that do not need to be closed.
